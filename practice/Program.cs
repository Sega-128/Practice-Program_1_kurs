...
double CalculateFuelCost(double consumption, double distance, double fuelPrice)
{
...
void DisplayConvertedCosts(double totalCost, double monthlyCost, double yearlyCost, string currency, double rate)
{
